...
public class TroopTypesCompatibility {
	...
	static{
		...
		_map.add(TroopType.INFANTRY, FormationLevel.ARMY, TroopType.MOTORIZED);
		_map.add(TroopType.INFANTRY, FormationLevel.ARMY, TroopType.ARMOURED);
		...
		_map.add(TroopType.INFANTRY, FormationLevel.ARMY_GROUP, TroopType.MOTORIZED);
		_map.add(TroopType.INFANTRY, FormationLevel.ARMY_GROUP, TroopType.ARMOURED);
